...
[MathJax <i class="fa fa-external-link" aria-hidden="true"></i>](https://docs.mathjax.org/en/latest/){: target="_blank" }

- 수식입력 LaTeX 예제 <i class="fa fa-angle-double-right" aria-hidden="true"></i>
[LaTeX/Mathematics <i class="fa fa-external-link" aria-hidden="true"></i>](https://en.wikibooks.org/wiki/LaTeX/Mathematics){: target="_blank" }
